...
// guard();  // Uncomment this if you want to restrict access to logged-in users

// Retrieve student data using index from session or display error if not found
if (isset($_GET['index'])) {
    $index = $_GET['index'];
    ...
    if (!$student) {
        ...
        echo "<p>Student not found. Please <a href='register.php'>return to the registration page</a>.</p>";
        exit;
    }
} else {
    // Display an error message if no index is provided
    echo "<p>No student index provided. Please <a href='register.php'>return to the registration page</a>.</p>";
    exit;
}
